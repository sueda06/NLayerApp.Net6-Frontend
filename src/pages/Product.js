...
function Product() {
        ...
        const refreshList = () => {
          axios.get(variables.API_URL + 'Products', { headers: { "Authorization": window.localStorage.getItem("token") } })
            .then(response => {
        ...
        const deleteClick = (id) => {
          if (window.confirm('Are you sure?')) {
            axios.delete(variables.API_URL + 'Products/' + id, { headers: { "Authorization": window.localStorage.getItem("token") } })
              .then((result) => {
                toast.success('Success', {
                  position: toast.POSITION.TOP_RIGHT
                });
